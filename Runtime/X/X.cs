...
namespace DarkMagic
{
    ...
    public static class X
    {
        ...
        public static void AddPosX(this Transform t, float dx)
        {
            var p = t.position;
            p.x += dx;
            t.position = p;
        ...
        public static void AddPosY(this Transform t, float dy)
        {
            var p = t.position;
            p.y += dy;
            t.position = p;
        ...
        public static void AddPosZ(this Transform t, float dz)
        {
            var p = t.position;
            p.z += dz;
            t.position = p;
        ...
        public static void AddLocalX(this Transform t, float dx)
        {
            var p = t.localPosition;
            p.x += dx;
            t.localPosition = p;
        ...
        public static void AddLocalY(this Transform t, float dy)
        {
            var p = t.localPosition;
            p.y += dy;
            t.localPosition = p;
        ...
        public static void AddLocalZ(this Transform t, float dz)
        {
            var p = t.localPosition;
            p.z += dz;
            t.localPosition = p;
        ...
        public static void AddScaleX(this Transform t, float dx)
        {
            var s = t.localScale;
            s.x += dx;
            t.localScale = s;
        ...
        public static void AddScaleY(this Transform t, float dy)
        {
            var s = t.localScale;
            s.y += dy;
            t.localScale = s;
        ...
        public static void AddScaleZ(this Transform t, float dz)
        {
            var s = t.localScale;
            s.z += dz;
            t.localScale = s;
